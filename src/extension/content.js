...
const source = new EventSource("https://api.openai.com/v1/conversations/${chatChannel.name}/messages/stream");
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.type === "ASK_CHATGPT") {
    ...
    // Send the text to the SSE endpoint
    ...
    source.send(JSON.stringify({ message: text }));
  }
});
